...
pub struct SfcParseOptions {
    ...
    pub template_parse_options: Option<vize_compiler_core::options::ParserOptions>,
}
...
pub struct TemplateCompileOptions {
    ...
    /// Compiler options
    pub compiler_options: Option<vize_compiler_dom::DomCompilerOptions>,
}
...
impl From<vize_compiler_core::CompilerError> for SfcError {
    fn from(err: vize_compiler_core::CompilerError) -> Self {
        Self {
            message: err.message,
